...
/** Product profile (NFC_PROFILE choice in Kconfig). Bundles role + protocols. */
#define NFC_IS_PROFILE_READER IS_ENABLED(CONFIG_NFC_PROFILE_READER)
#define NFC_IS_PROFILE_CE     IS_ENABLED(CONFIG_NFC_PROFILE_CARD_EMULATION)
#define NFC_IS_PROFILE_LAB    IS_ENABLED(CONFIG_NFC_PROFILE_LAB)
