...
ZTEST(nfc_reader_loopback, test_virtual_loopback_classic_4k_7b)
{
	classic_loopback_run(classic_MfClassic_4K_7b_model, CLASSIC_MFCLASSIC_4K_7B_MODEL_LEN,
			     store_fixture_mfclassic_4k_7b_card,
			     STORE_FIXTURE_MFCLASSIC_4K_7B_CARD_LEN, "4k_7b");
}
#endif
...
ZTEST(nfc_reader_loopback, test_virtual_loopback_classic_mini_7b)
{
	classic_loopback_run(classic_MfClassic_Mini_7b_model, CLASSIC_MFCLASSIC_MINI_7B_MODEL_LEN,
			     store_fixture_mfclassic_mini_7b_card,
			     STORE_FIXTURE_MFCLASSIC_MINI_7B_CARD_LEN, "mini_7b");
}
#endif /* CONFIG_NFC_PROTOCOL_CLASSIC */
