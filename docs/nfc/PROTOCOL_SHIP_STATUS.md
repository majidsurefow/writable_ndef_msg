...
| P6 | Classic | **SHIPPED** | N/A (Flipper golden) | MfClassic_{1K_4b,1K_7b,4K_4b,4K_7b,Mini_4b,Mini_7b} + `.card.bin` | full TX assert (98/337/32) | virtual listener + Crypto1 | yes (`classic_compare`, 6 variants) | f14e92b |
